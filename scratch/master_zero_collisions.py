...
def get_master_tracks():
    ...
    # =========================================================================
    # 12V Power from TB1 (4.8, 44.2) and (9.6, 44.2)
    # 12V+ runs across along Y=44.2 to X=18.5, then down to TB_IND (18.5, 24.2)
    tracks.append({'net': '12V_TO_TB_IND', 'layer': 'top', 'width': 1.6,
        'pts': [(4.8, 44.2), (18.5, 44.2), (18.5, 24.2)]})
    tracks.append({'net': '12V_GND_TO_TB_IND', 'layer': 'top', 'width': 1.4,
        'pts': [(9.6, 44.2), (9.6, 43.0), (21.3, 43.0), (21.3, 24.2)]})
    ...
    # PGND Power Ground Rail on Top Copper
    tracks.append({'net': 'PGND_TVS', 'layer': 'top', 'width': 2.0,
        'pts': [(9.6, 31.8), (4.3, 31.8), (4.3, 16.2)]})
    ...
    # 5V_LOGIC Rail on Top Copper
    tracks.append({'net': 'MEGA_5V_TO_FB1', 'layer': 'top', 'width': 1.3,
        'pts': [(42.66, 2.4), (42.66, 5.0), (38.0, 5.0), (38.0, 7.5)]})

    # Top Edge Signals on F.Cu (D10, D12)
