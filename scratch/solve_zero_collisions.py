...
def get_tracks():
    ...
    tracks.append({'net': 'HX711_SCK_38', 'layer': 'top', 'width': 0.55,
        'pts': [(84.0, 20.1), (84.0, 18.0), (97.0, 18.0), (97.0, 35.32), (100.04, 35.32)]})
    ...
    tracks.append({'net': 'PP_TOP_ECHO_34', 'layer': 'top', 'width': 0.55,
        'pts': [(75.8, 40.2), (75.8, 36.0), (89.5, 36.0), (89.5, 30.24), (100.04, 30.24)]})
    # Pin 32: CAN_INDUCTIVE (33.5, 25.5) -> Y=27.70
    tracks.append({'net': 'CAN_INDUCTIVE_PIN32', 'layer': 'top', 'width': 0.7,
        'pts': [(33.5, 25.5), (33.5, 21.0), (95.0, 21.0), (95.0, 27.70), (100.04, 27.70)]})
    ...
    # Pin 28: M_DROP_PWM (61.58, 17.0) -> Y=22.62
