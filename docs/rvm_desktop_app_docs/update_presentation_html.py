...
new_js = '''    const screensData = {
      ...
      2: {
        ...
        instruction: "Citizen Action: Press the '0' or '*' button on the physical keypad to start recycling.",
        specs: [
          { label: "Keypad Trigger", val: "Press '0' or '*' Key" },
          { label: "Hardware Input", val: "12-Key Physical Keypad" },
      ...
      3: {
        ...
        desc: "This is the first active step of the recycling process. By pressing the '0' button on the physical keypad, the citizen indicates readiness. The motorized security gate opens, internal chamber lights turn ON, and optical sensors begin listening.",
      ...
      7: {
        ...
        desc: "The citizen has finished inserting containers. The screen prompts for their 11-digit Pakistani mobile phone number (03xxxxxxxxx) to transfer earned points into their digital wallet. Upon entering phone number and pressing Enter, the system proceeds to experience rating.",
        instruction: "Citizen Action: Type your 11-digit mobile number using the keypad, then press 'Enter' to claim points and proceed to rating.",
        specs: [
          ...
          { label: "Next Transition", val: "Auto-proceed to Rating" }
        ],
        highlightKey: "Enter",
      ...
      8: {
        ...
        desc: "Indicates that the recycling session is committed. The transaction is written to the local database and pushed to the Central Cloud via secure API. The citizen's wallet points balance is updated immediately.",
        instruction: "Citizen Action: Review your credit confirmation on screen. Proceed to customer experience rating.",
        specs: [
          ...
          { label: "Account Dispatch", val: "Real-Time Balance Update" }
        ],
        highlightKey: null,
      ...
      9: {
        ...
        desc: "Citizens are invited to submit their feedback regarding machine cleanliness, speed, and overall satisfaction using an interactive 5-star rating system.",
        instruction: "Citizen Action: Press a keypad number from 1 (Very Bad) to 5 (Excellent), then press 'Enter' to confirm (or wait 8s for auto-completion).",
        specs: [
          { label: "Keypad Input", val: "Keys 1 to 5, Enter to Confirm" },
          { label: "Rating Scale", val: "1 = Very Bad to 5 = Excellent" },
          { label: "Auto-Finish", val: "8 Seconds Auto-Submit" },
          { label: "Cloud Sync", val: "POST /api/machine/feedback" }
        ],
        highlightKey: "5",
